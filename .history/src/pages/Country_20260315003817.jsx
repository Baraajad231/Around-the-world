      ...
      {!isError && !isLoading && (
        <div>
          ...
          <div className="grid gap-11 lg:grid-cols-2 lg:gap-36">
            <img className="w-full" src={result?.flags?.svg} />
            <div>
              ...
              <div className="flex flex-col gap-8 md:gap-40 lg:flex-row">
                <div className="flex flex-col gap-5">
                  ...
                  <p>
                    ...
                    <span className="font-thin">{result?.region}</span>
                  </p>
                  <p>
                    <span className="font-semibold">Sub Region: </span>
                    <span className="font-thin">{result?.subregion}</span>
                  </p>
                  <p>
                    <span className="font-semibold">Capital: </span>
                    <span className="font-thin">{result?.capital}</span>
                  </p>
                </div>
                <div className="flex flex-col gap-5">
                  <p>
                    <span className="font-semibold">Top Level Domain: </span>
                    <span className="font-thin">{result?.tld?.join(",")}</span>
                  </p>
                  <p>
                    <span className="font-semibold">Currencies:</span>
                    <span className="font-thin">{Object.keys(result?.currencies).map((res)=> res).join(,)}</span>
                  </p>
                  <p>
                    <span className="font-semibold">Languages:</span>
                    <span className="font-thin">Egypt</span>
                  </p>
                </div>
              </div>
            </div>
